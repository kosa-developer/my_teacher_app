                        ...
                        <div class="row">
                                        ...
                                        <div class="card-body " id="bar-parent">
                                            <div class="col-md-8">
                                                <div class="form-group col-md-4">
                                                    <label>Class:</label>
                                                    <select name="class" class="select2" style="width: 100%" onchange="returnsubject(this.value, 'returned_subject');" required>
                            ...
                            <div  class="col-md-12" <?php echo $hidden2; ?>>
                                ...
                                if (isset($_GET['action']) && $_GET['action'] == 'delete') {
                                    ...
                                    Redirect::go_to("index.php?page=policy_answer&mode=" . $mode . "&subject=" . $subject);
                                }
                                ?>
                                                                    ...
                                                                    <td style="width: 20%;"><?php echo $questionx->Choice; ?>
                                                                        <div class="btn-group xs">
                                                                            ...
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                ...
                                                                                <li><a href="index.php?page=<?php echo "policy_answer" . '&action=delete&question_id=' . $questionx->Question_Id . '&mode=' . $mode . '&subject=' . $subject; ?>" onclick="return confirm('Are you sure you want to delete <?php echo $questionx->Question; ?>?');">Delete</a></li>
                                                                                <li class="divider"></li>
